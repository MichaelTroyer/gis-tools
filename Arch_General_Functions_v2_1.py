...
class Toolbox(object):   
    def __init__(self):
        self.label = "Arch_General_Functions_v2_1"
        self.alias = "Arch_General_Functions"
        
        # List of tool classes associated with this toolbox
        self.tools = [Arch_General_Functions_v2_1]


class Arch_General_Functions_v2_1(object):
    def __init__(self):
        self.label = "Arch_General_Functions_v2_1"
        self.description = ""
...
###
        ...
        #Reclass and Convert to Polygon
        param16 = arcpy.Parameter(
            displayName="Reclassify Slope",
            name="Output_Reclass",
            datatype="Boolean",
            parameterType="Optional",
            category = "Data Options",
    ...
    def execute(self, params, messages):
        ...
        Geology             = r'T:\CO\GIS\gisuser\rgfo\mtroyer\z-Misc\z_Data\Data.gdb\Geology'
        Soils               = r'T:\CO\GIS\gisuser\rgfo\mtroyer\z-Misc\z_Data\Data.gdb\Soils'
        ...
        try:
            ...
            if params[15].value == 1:
                try:
                    ...
                    arcpy.AddMessage("Slope FAILED")

            #Reclassify the slope
            if params[16].value == 1:
                try:
                    arcpy.AddMessage("Reclassifying Slope")
                    out_reclass_raster = envPath+"\\reclass"
                    out_reclass_poly   = envPath+"\\reclass_poly.shp"
                    
                    arcpy.Reclassify_3d(
                        in_raster=param15Name, out_raster=out_reclass_raster,
                        reclass_field='VALUE',  missing_values='DATA',
                        remap='0 10 10;10 20 20;20 30 30;30 40 40;40 91 50')

                    arcpy.RasterToPolygon_conversion(
                        in_raster=out_reclass_raster,
                        out_polygon_features=out_reclass_poly,
                        simplify='SIMPLIFY', raster_field='VALUE')
                except:
                    arcpy.AddMessage("Reclassification FAILED")
