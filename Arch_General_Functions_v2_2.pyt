...
###
    ...
    def execute(self, params, messages):
        ...
        shpoSurveyTarget    = r'T:\CO\GIS\gistools\tools\Cultural\Templates\SHPO_Templates'\
                              r'\survey_ply_tmp.shp'
        shpoSiteTarget      = r'T:\CO\GIS\gistools\tools\Cultural\Templates\SHPO_Templates'\
                              r'\site_ply_tmp.shp'
...
##                arcpy.mapping.AddLayer(df1, polyLyr, "TOP")
            ...
            pnts = [(pnt.X, pnt.Y) for row in arcpy.da.SearchCursor(
                     params[0].value, ["OID@", "SHAPE@"]) for part in row[1] for pnt in part]
