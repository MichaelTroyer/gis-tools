...
class Toolbox(object):
    def __init__(self):
        self.label = "Continuous_Data_Model"
        self.alias = "Continuous_Data_Model"
        self.tools = [Continuous_Data_Model]
class Continuous_Data_Model(object):
    def __init__(self):
        self.label = "Continuous_Data_Model"
        self.description = ""
    ...
    def execute(self, params, messages):
        ...
        ###Add a clear selection function
            ...
            arcpy.SelectLayerByAttribute_management("in_memory\\testPoints", "CLEAR_SELECTION")
