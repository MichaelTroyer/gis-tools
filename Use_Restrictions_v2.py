...
Union the feature classes by input criteria (as parameter) and union criteria with analysis area.
...
To Do:
def write_location_matrix_to_target(target, location_fc):
    preprocess: clip, planarize
    union with target
    add field
    select by location - Within
    calculate acreage
    get acres
    return default_dict (acre field, acres)...
"""
...
import copy, csv, datetime, getpass, os, re, sys, traceback
import arcpy
#import math
#import numpy as np
#import pandas as pd
...
class Toolbox(object):
    def __init__(self):
        self.label = "Use_Restrictions_v2"
        self.alias = "Use_Restrictions_v2"

        # List of tool classes associated with this toolbox
        self.tools = [Use_Restrictions_v2]


class Use_Restrictions_v2(object):
    def __init__(self):
        self.label = "Use_Restrictions_v2"
        self.description = ""
        # Will likely fail if set to false - memory error in 32 bit env
...
###################################################################################################
            ...
            input_params = {'02air_quality_climate':
                            ...
                            '06geology':
                                [parameters[6].valueAsText, 'Resources', 'GEO'],
            ...
            if alternative == "ALT_D":
                ...
                for ecoregion_fc in ecoregion_rename:
                    ...
                    # Add key=fc_id and value=acreage to sweet default dictionary
                    ecoregion_markup_acres[ecoregion_fc] = round(ecoregion_acres, 2)
            ...
            with open(outCSV, 'wb') as csvfile:
                ...
                csvwriter.writerow(['Criteria', analysis_id+"_Raw_Acres",
